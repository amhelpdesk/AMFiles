...
Dim installroot
installroot = WshShell.ExpandEnvironmentStrings("%PROGRAMFILES(x86)%")
...
WshShell.RegWrite "HKEY_CURRENT_USER\Software\Classes\TRIM5.Record.Reference\Shell\Open\command\", chr(34) & "C:\Program Files (x86)\Micro Focus\Content Manager\trim.exe" & chr(34) & " " & chr(34) & "%1" & chr(34), "REG_SZ"
